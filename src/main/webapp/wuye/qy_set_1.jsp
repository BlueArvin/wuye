      ...
      <ul class="search">
        <li>
        	<div class="form-group">
	          <label>城区名称：</label>
	          <input type="hidden" class="input" id="type" name="type" value=1 style="float:right" />
...
function load(pageNum){
	...
	location.href="/manager/toAreaSetChild.aspx?type=1&pageNum="+pageNum;
}
	...
	if(confirm("您确定要删除吗?")){
		$.ajax({
			...
			success : function(data) {
				console.log(data);
				alert(data.msg);
				location.href="/manager/toAreaSetChild.aspx?type=1&pageNum=1";
			},
			error : function() {
				alert("请求异常！");
			}
