      ...
      <ul class="search">
        <li>
        	<div class="form-group">
	          <label>街道名称：</label>
	          <select name="type" class="input w66" name="streetId" style="float:right" >
	        ...
	        <div class="form-group">
	          <label>片区名称：</label>
	          <input type="hidden" class="input" name="pianquId" value=0 style="float:right" />
	          <input type="text" class="input" name="pianquName" style="float:right" />
	        </div>
	    </li>
