      ...
      <ul class="search">
        <li>
        	<div class="form-group">
	          <label>片区名称：</label>
	          <select name="type" class="input w66" name="pianquId" style="float:right" >
	        ...
	        <div class="form-group">
	          <label>胡同名称：</label>
	          <input type="hidden" class="input" name="hutongId" value=0 style="float:right" />
	          <input type="text" class="input" name="hutongName" style="float:right" />
	        </div>
	    </li>
